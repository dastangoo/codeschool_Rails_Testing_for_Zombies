...
class ZombiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post zombies_url, params: { zombie: { graveyard: @zombie.graveyard, name: @zombie.name } }
    end
  ...
  test "should update zombie" do
    patch zombie_url(@zombie), params: { zombie: { graveyard: @zombie.graveyard, name: @zombie.name } }
